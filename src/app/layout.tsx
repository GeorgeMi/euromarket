...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "statii epurare ape uzate",
    "tratare ape uzate",
    "statie tratare apa",
    "epurare ape uzate",
    "statie de epurare pret",
    "statie epurare pret",
    "statii de epurare pentru case",
    "mini statie epurare",
    "statie epurare casa individuala",
    "statie epurare industriala",
    "statie epurare municipala",
    "statie epurare fara vidanjare",
    "proiectare statie epurare",
    "constructie statie epurare",
    "montaj statie epurare",
    "intretinere statie epurare",
    "statie epurare MBBR",
    "statie epurare SBR",
    "statie epurare MBR",
    "MBBR",
    "SBR",
    "MBR",
    "statie epurare pensiune",
    "statie epurare restaurant",
    "statie epurare hotel",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Euromarket - Stații de Epurare și Tratare Ape Uzate România",
      },
    ],
  },
  twitter: {
