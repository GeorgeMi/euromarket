export const translations = {
  en: {
    ...
    hero: {
      ...
      title3: "Engineering",
      description:
        "Established in 1996, Euromarket WWE SRL is a reputable, highly competent, and professional water and wastewater engineering company with international operations in Europe and the Middle East.",
      cta1: "View Our Work",
      cta2: "Get in Touch",
    ...
    about: {
      ...
      description:
        "Euromarket WWE SRL was established in 1996 when the construction of wastewater treatment plants was a new and growing market in Cyprus and the Middle East. In 1996, the Romania branch was established, consolidating our position in the European market. ISO 9001:2000 certified, we have completed over 500 projects across Europe and the Middle East. Our own chemical laboratory ensures precise quality control, while continuous R&D investments keep us at the forefront of water treatment technology. Health and Safety remain fundamental principles in all our operations.",
      highlights: [
  ...
  ro: {
    ...
    hero: {
      ...
      description:
        "Fondată în 1996, Euromarket WWE SRL este o companie de prestigiu, înalt competentă și profesionistă în domeniul ingineriei apei și apelor uzate, cu operațiuni internaționale în Europa și Orientul Mijlociu.",
